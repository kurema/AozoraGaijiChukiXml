...
public class UnitTest1
{
	...
	public void Test2()
	{
		Assert.Null(Record.Exception(() => { var r1 = Aozora.GaijiChuki.Manager.Toc.RadicalFromStroke; }));
		Assert.Null(Record.Exception(() => { var r1 = Aozora.GaijiChuki.Manager.Toc.RadicalCharacters; }));
		Assert.Null(Record.Exception(() => { var r1 = Aozora.GaijiChuki.Manager.Toc.RadicalFromReadings; }));
	}
}